...
import pytest
from open_brain_engine.storage.filesystem import DurabilityError, atomic_replace
from open_brain_engine.storage.writer_record import (
...
def test_writer_record_rejects_independent_read_back_mismatch(
    ...
    import open_brain_engine.storage.writer_record as writer_record_module
