...
from open_brain.operations.doctor import FindingClass as AuthoritativeFindingClass
from open_brain.operations.doctor import HistoricalDiagnosis as AuthoritativeHistoricalDiagnosis
from open_brain.operations.doctor import ProbeName as AuthoritativeProbeName
from open_brain.operations.doctor import ProbeReading as AuthoritativeProbeReading
from open_brain.operations.doctor import ProbeState as AuthoritativeProbeState
...
def test_phase7_manifest_is_fixed_versioned_and_complete() -> None:
    ...
    assert PARITY_SCHEMA_DIGEST_SHA256 == (
        "f4ff454b521d2f71422ffdc180f8757a847c3481769df109c65618bcb8d98279"
    )
