.PHONY: dev build test lint typecheck audit audit-history phase4-contracts p4w5-focused p4w5-native-config p4w5-native-contracts p4w5-preflight p4w5-native verify-artifacts verify
