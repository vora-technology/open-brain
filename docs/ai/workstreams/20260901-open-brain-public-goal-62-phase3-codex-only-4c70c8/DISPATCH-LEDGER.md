...
| `P3-W2-RUNTIME-04` | implementation | `gpt-5.4` | high | W2 scheduler/supervisors/entrypoints, exclusive | pending | control subphase verified; ready to dispatch |
