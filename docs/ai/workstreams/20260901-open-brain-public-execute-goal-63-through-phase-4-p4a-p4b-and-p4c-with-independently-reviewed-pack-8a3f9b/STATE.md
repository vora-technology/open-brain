...
- Pre-commit verification is green: 27 focused P4-W6 tests, 10 release-policy tests, 146 Phase 4
  contracts, strict MyPy on 549 files, all 3,248 repository tests, six source-free artifacts,
